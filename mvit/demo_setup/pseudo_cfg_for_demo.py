...
class cfg:
    ...
    MVIT.PATCH_KERNEL = [1, 7, 7]
    MVIT.PATCH_STRIDE = [1, 4, 4]
    MVIT.PATCH_PADDING = [1, 3, 3]
    MVIT.EMBED_DIM = 96
    MVIT.NUM_HEADS = 1
    MVIT.MLP_RATIO = 4.0
    MVIT.QKV_BIAS = True
    ...
    MVIT.POOL_KV_STRIDE_ADAPTIVE = [1, 4, 4]
    MVIT.POOL_Q_STRIDE = [[0, 1, 1, 1], [1, 1, 2, 2], [2, 1, 1, 1], [3, 1, 2, 2], [4, 1, 1, 1], [5, 1, 1, 1], [6, 1, 1, 1], [7, 1, 1, 1], [8, 1, 1, 1], [9, 1, 1, 1]]
    MVIT.POOL_KVQ_KERNEL = [1, 3, 3]
